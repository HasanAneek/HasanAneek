...
<div class="highlight highlight-source-js notranslate position-relative overflow-auto" data-snippet-clipboard-copy-content="{
  ...
  <span class="pl-c1">programmingLanguages</span>: <span class="pl-kos">[</span><span class="pl-s">'PHP'</span><span class="pl-kos">,</span> <span class="pl-s">'JavaScript'</span><span class="pl-s">'Python'</span><span class="pl-kos">]</span><span class="pl-kos">,</span><span class="pl-c1">frameworks</span>: <span class="pl-kos">[</span><span class="pl-s">'Laravel'</span><span class="pl-kos">,</span> <span class="pl-s">'AlpineJS'</span><span class="pl-kos">>}</span></pre></div>
